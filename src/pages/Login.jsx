...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({
        submit: "Kirish parolda xatolik yuz berdi. Qayta urinib ko'ring.",
      });
    } finally {
      setLoading(false);
    }
          ...
          <div className="hidden lg:block">
            <div className="max-w-xl">
              ...
              <p className="text-xl text-gray-600 mb-12 leading-relaxed">
                Minglab vakansiyalar va top kompaniyalar sizni kutmoqda. Bugun
                orzuyingizda ishni boshlang!
              </p>
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0">
            <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-10 border border-gray-100 backdrop-blur-sm bg-white/95">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-5">
                  <div>
                    <label
                      htmlFor="email"
                      className="block text-sm font-semibold text-dark mb-3"
                    >
                      Email manzil
                    </label>
              ...
              <div className="mt-6 p-4 bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl border border-primary-200">
                <p className="text-xs font-semibold text-primary-800 text-center mb-2">
                  Demo uchun:
                </p>
